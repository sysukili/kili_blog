...
//   Custom title page
#let title_page(title, subtitle,picture)={
    page(margin: 0in,
        background: image(picture, height: 100%, fit: "cover"))[
        #set text(fill: white)

        #place(center + horizon, dy: -2.75in)[
            #set align(center + horizon)
            #block(width: 100%, fill: posit_colors.dark_blue_3, outset: 3em)[
...
#let posit(
  ...
  if title != none {
    title_page(title, subtitle,picture)
  }
